...
window.Inventto =
  empresa:
    ...
    visao:
      """
      Ser referência em inovação tecnológica não apenas pela qualidade e complexidade das invenções desenvolvidas mas também pela ênfase no processo aberto e transparente.
      """
  acreditamos:
